...
main = hakyllWith config $ do
  forM_ ["CNAME", "sitemap.txt", "robots.txt", "favicon.ico", "books/*.epub", "books/*.pdf", "books/*.mobi", "books/*/*.svg", "books/*/images/*.png", "books/*/print.css", "books/*/stylesheet.css"] $ \f -> match f $ do
    route idRoute
